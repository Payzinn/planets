...
function Main_Solar(canvas) {
    ...
    var dt  = 2 * t0;                 // шаг интегрирования

    // *** Выполнение программы ***

    var space_objects = [];
    // значения distance и time_around_Sun у солнца сделаны для того, чтобы оно мерцало из-за движения
    space_objects.push({name:"Солнце",    mass:3330000*m0, distance:0.001*a0,  radius:109.21*r0, time_around_Sun:60*t0,    phase:0,    color:"#f6e209",    file:"VL_SS_Sun.png"});
    ...
    space_objects.push({name:"Сатурн",    mass:95.2*m0,   distance:9.54*a0,   radius:9999*r0, time_around_Sun:4*t1,   phase:0,    color:"#c69e47",    file:"VL_SS_Saturn.png"});
